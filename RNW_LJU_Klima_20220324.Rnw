...
%%\include{AAAAbstract}
%%\begin{abstract}
%% Kratek opis klimatskih sprememb v Ljubljani
%% \end{abstract}
%% \tableofcontents
\clearpage
\listoffigures
%% Povprečne letne dnevne temperature
\clearpage
\begin{figure}[ht]
...
@
\end{figure}
%% Skupno mesečno sončno obsevanje
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
tmp.month.stat <- subset (month.stat, subset = month <= "2021-12-31")
...
@
\end{figure}
%% Povprečne mesečne temperature referenčnega obdobja
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava povprečnih mesečnih temperatur referenčnega obdobja in zadnjega leta
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava skupnih padavin referenčnega obdobja in zadnjega leta
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava skupnega sončnega obsevanja referenčnega obdobja in zadnjega leta
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava mesečnih povprečij minimalnih, povprečnih in maksimalnih dnevnih temperatur referenčnega obdobja in zadnjega leta
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava skupnih mesečnih padavin referenčnega obdobja in zadnjega leta
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava verjetnosti dežja referenčnega obdobja in dejanskega dežja zadnjega leta
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava mesečnih povprečij minimalnih, povprečnih in maksimalnih dnevnih temperatur referenčnega obdobja in zadnjega leta na izbranem intervalu
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava skupnih mesečnih padavin referenčnega obdobja in zadnjega leta na izbranem intervalu
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
tmp.start <- "2021-01-01"
...
@
\end{figure}
%% Primerjava skupnega mesečnega sončnega obsevanja referenčnega obdobja in zadnjega leta na izbranem intervalu
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Primerjava mesečnih povprečij dnevnih temperatur referenčnega obdobja in zadnjega leta na izbranem intervalu
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
...
@
\end{figure}
%% Število tropskih noči po letih
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
library (ggplot2)
...
@
\end{figure}
%% Število dni z zmrzaljo po letih
\clearpage
\begin{figure}[ht]
<<eval=TRUE,echo=FALSE,results="asis",cache=FALSE,warning=FALSE,message=FALSE,comment=NA,out.width='100%'>>=
library (ggplot2)
...
\end{figure}
\clearpage
%% Število dni s padavinami v letu
\begin{figure}[ht]
<<eval=TRUE, echo=FALSE, results="asis", cache=FALSE, warning=FALSE, message=FALSE, comment=NA, out.width='100%'>>=
...
@
\end{figure}
%% Analiza časovnih vrst letnih povprečij temperature
\clearpage
\begin{figure}[ht]
<<eval=TRUE, echo=FALSE, results="asis", cache=FALSE, warning=FALSE, message=FALSE, comment=NA, out.width='100%'>>=
...
%% Analiza časovnih vrst skupnih letnih padavin
\clearpage
\begin{figure}[ht]
<<eval=TRUE, echo=FALSE, results="asis", cache=FALSE, warning=FALSE, message=FALSE, comment=NA, out.width='100%'>>=
...
@
\end{figure}
%% Analiza časovnih vrst skupnega letnega sončnega obsevanja
\clearpage
\begin{figure}[ht]
<<eval=TRUE, echo=FALSE, results="asis", cache=FALSE, warning=FALSE, message=FALSE, comment=NA, out.width='100%'>>=
